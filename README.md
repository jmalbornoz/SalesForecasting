...
In this repo, we will explore how PyCaret, an automated machine learning Python package, can be utilised to forecast sales in a US-based brick-and-mortar store. The sales time series that we will be looking represents daily sales in US dollars. We examine scenarios both with and without exogenous variables.
